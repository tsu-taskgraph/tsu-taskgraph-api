...
public class UserController {
    ...
    @PatchMapping
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Обновить профиль (displayName)")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Загрузить / заменить аватар текущего пользователя")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Удалить аватар (сбросить на дефолтный)")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Получить AI-настройки (ключ замаскирован)")
    ...
    @ResponseStatus(HttpStatus.OK)
    @Operation(summary = "Сохранить AI-настройки (ключ шифруется AES-256)")
    ...
    @Operation(summary = "Удалить AI-настройки и ключ")
